...
public class ThursdayUser extends Fragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        database.getReference("Users").child(currentUser.getUid()).child("adminPhoneNumber").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                ...
                databaseReference = database.getReference("Schedule").child(adminId).child("Thursday");
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull final DataSnapshot snapshot) {
                        ...
                        for (int i = 0; i < scheduleList.size(); i++) {
                            ...
                            if (currentTime.compareTo(endTimeString) > 0 && dayOfWeek == Calendar.THURSDAY){
