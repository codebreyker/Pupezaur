...
//
//public class ParentMainActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
//    FirebaseAuth auth;
...
////                View view = inflater.inflate(R.layout.fragment_monday, null);
...
//            Intent intent = new Intent(ParentMainActivity.this, ChatActivity.class);
...
//            Intent intent = new Intent (ParentMainActivity.this, SettingsActivity.class);
//            startActivity(intent);
//            return false;
//        }
////            buton logout
...
//            startActivity(new Intent (ParentMainActivity.this, UserPhoneRegister.class));
//            finish();
//        }
//
...
//                fragmentMonday.startHour(f24Hour.format(date));
...
//            try {
//                Date date = f24Hour.parse(hour + ":" + minute);
//                fragmentMonday.endHour(f24Hour.format(date));
