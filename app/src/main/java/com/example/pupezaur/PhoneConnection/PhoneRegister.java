    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PhoneRegister.this, PhoneSignin.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                if (TextUtils.isEmpty(phoneNumber)) {
                                                    Toast.makeText(PhoneRegister.this, "Please write a valid phone number", Toast.LENGTH_SHORT).show();
                                                } else {
...
//                                                    phoneAuth.setVisibility(View.VISIBLE);
                                                    ...
                                                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                                                            ...
                                                            PhoneRegister.this,               // Activity (for callback binding)
                ...
                mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(@NonNull FirebaseException e) {
                        ...
                        Toast.makeText(PhoneRegister.this, "Invalid phone number.", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                    ...
                    public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                        ...
                        loadingBar.dismiss();
                        Toast.makeText(PhoneRegister.this, "Code has been sent, please check", Toast.LENGTH_SHORT).show();
                    }
                };
...
//                llayout.setVisibility(View.INVISIBLE);
                ...
                if (TextUtils.isEmpty(verificationCode)) {
                    Toast.makeText(PhoneRegister.this, "Please write verification code first", Toast.LENGTH_SHORT).show();
                } else {
...
//                            finish();
                            ...
                            hashMap.put("adminPhoneNumber", admin_phone_number.getText().toString());
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(PhoneRegister.this, "Error: " + e, Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
