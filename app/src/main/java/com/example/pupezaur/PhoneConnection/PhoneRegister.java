        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(txt_username) || TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_password)) {
                    ...
                    Toast.makeText(PhoneRegister.this, "Password must be at least 6 characters", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Intent intent = new Intent(PhoneRegister.this, SigninActivity.class);
                            ...
                            Toast.makeText(PhoneRegister.this, "You can't register with this email or password", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        btnlogin = findViewById(R.id.btnlogin);
