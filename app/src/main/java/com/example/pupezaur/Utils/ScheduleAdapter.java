...
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.ViewHolder> {
    ...
    public void ScheduleUtil (Context context, List<ScheduleUtil> scheduleList, DatabaseReference databaseReference) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ScheduleUtil schedule = scheduleList.get(position);
