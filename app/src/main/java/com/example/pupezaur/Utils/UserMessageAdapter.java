...
public class UserMessageAdapter extends RecyclerView.Adapter<UserMessageAdapter.ViewHolder> {
    ...
    public UserMessageAdapter(Context context, List<Message> messageList, DatabaseReference databaseReference) {
    ...
    public void deleteMessage(final int position, final ViewHolder holder) {
        ...
        FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid()).child("adminPhoneNumber").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                adminId = snapshot.getValue().toString();
                DatabaseReference db = FirebaseDatabase.getInstance().getReference("Chats").child(adminId).child(messageList.get(position).getKey());
