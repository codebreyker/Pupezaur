...
//        butonul de adaugat ore
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((startTimeString.isEmpty() || endTimeString.isEmpty()) && !scheduleList.isEmpty()) {
                    Toast.makeText(Wednesday.this, "Please select start hour", Toast.LENGTH_SHORT).show();
                } else {
        ...
        //        butoanele cu zile
        btn_monday.setSupportBackgroundTintList(ContextCompat.getColorStateList(Wednesday.this, R.color.BaseTurquoise));
        btn_tuesday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Wednesday.this, Tuesday.class));
        ...
        btn_wednesday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Wednesday.this, Wednesday.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
        btn_thursday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Wednesday.this, Thursday.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
        btn_friday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Wednesday.this, Friday.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
        btn_saturday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Wednesday.this, Saturday.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
        btn_sunday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Wednesday.this, Sunday.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
...
//            buton chat
        if (id == R.id.ChatButton) {
            Intent intent = new Intent(Wednesday.this, ChatActivity.class);
...
//            buton setari
        if (id == R.id.btn_settings){
            Intent intent = new Intent (Wednesday.this, SettingsActivity.class);
            startActivity(intent);
            return false;
        }
//            buton logout
        if (id == R.id.btn_logout) {
            ...
            startActivity(new Intent (Wednesday.this, AdminPhoneRegister.class));
            finish();
        }
