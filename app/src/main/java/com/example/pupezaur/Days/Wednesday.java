...
//
////        butoanele cu zile
//        btn_wednesday.setSupportBackgroundTintList(ContextCompat.getColorStateList(Wednesday.this, R.color.BaseTurquoise));
//
//        btn_monday.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                startActivity(new Intent(Wednesday.this, Monday.class));
