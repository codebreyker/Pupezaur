...
public class WednesdayAdmin extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference("Schedule").child(firebaseUser.getPhoneNumber()).child("Wednesday").keepSynced(true);
        ...
        v.setOnTouchListener(new OnSwipeTouchListener(WednesdayAdmin.this){
            @Override
            public void onSwipeLeft(){
                super.onSwipeLeft();
                startActivity(new Intent(WednesdayAdmin.this, ThursdayAdmin.class));
            ...
            public void onSwipeRight() {
                super.onSwipeRight();
                startActivity(new Intent(WednesdayAdmin.this, TuesdayAdmin.class));
...
//        buton adaugat cursuri
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((startTimeString.isEmpty() || endTimeString.isEmpty()) && !scheduleList.isEmpty()) {
                    Toast.makeText(WednesdayAdmin.this, "Please select start hour", Toast.LENGTH_SHORT).show();
                } else {
        ...
        //        butoanele cu zile
        btn_wednesday.setBackgroundResource(R.drawable.btns_days_blue);
        btn_wednesday.setTextColor(getResources().getColor(R.color.Black));
        btn_monday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(WednesdayAdmin.this, MondayAdmin.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                finish();
            }
        });
        ...
        btn_friday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(WednesdayAdmin.this, FridayAdmin.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
        btn_saturday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(WednesdayAdmin.this, SaturdayAdmin.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
        btn_sunday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(WednesdayAdmin.this, SundayAdmin.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
...
//                Log.e(TAG, "onDataChange: "+ AllMethods.name );
        ...
        databaseReference = database.getReference("Schedule").child(firebaseUser.getPhoneNumber()).child("Wednesday");
                        ...
                        public boolean onLongClick(View view) {
                            for (int i = 0; i < scheduleList.size(); i++) {
                                if (view.getId() == i) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(WednesdayAdmin.this);
                                    ...
                                    builder.setItems(options, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int j) {
                                            if (j == 0) {
                                                databaseReference = FirebaseDatabase.getInstance().getReference("Schedule").child(firebaseUser.getPhoneNumber()).child("Wednesday");
                                                databaseReference.child(scheduleList.get(finalI).getId()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(WednesdayAdmin.this, isDeleted, Toast.LENGTH_SHORT).show();
                                                        } else {
                                                            Toast.makeText(WednesdayAdmin.this, notDeleted, Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                });
                                                return;
...
//            buton chat
        if (id == R.id.chatButton) {
            Intent intent = new Intent(WednesdayAdmin.this, AdminChatActivity.class);
...
//            buton setari
        if (id == R.id.btn_settings){
            Intent intent = new Intent (WednesdayAdmin.this, SettingsActivity.class);
            startActivity(intent);
            return false;
        }
//            buton logout
        if (id == R.id.btn_logout) {
            ...
            startActivity(new Intent (WednesdayAdmin.this, AdminPhoneRegister.class));
            finish();
        }
