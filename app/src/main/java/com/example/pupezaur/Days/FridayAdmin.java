...
public class FridayAdmin extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference("Schedule").child(firebaseUser.getPhoneNumber()).child("Friday").keepSynced(true);
        ...
        v.setOnTouchListener(new OnSwipeTouchListener(FridayAdmin.this){
            @Override
            public void onSwipeLeft(){
                super.onSwipeLeft();
                startActivity(new Intent(FridayAdmin.this, SaturdayAdmin.class));
            ...
            public void onSwipeRight() {
                super.onSwipeRight();
                startActivity(new Intent(FridayAdmin.this, ThursdayAdmin.class));
...
//        buton adaugat cursuri
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((startTimeString.isEmpty() || endTimeString.isEmpty()) && !scheduleList.isEmpty()) {
                    Toast.makeText(FridayAdmin.this, "Please select start hour", Toast.LENGTH_SHORT).show();
                } else {
        ...
        //        butoanele cu zile
        btn_friday.setBackgroundResource(R.drawable.btns_days_blue);
        btn_friday.setTextColor(getResources().getColor(R.color.Black));
        btn_monday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FridayAdmin.this, MondayAdmin.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                finish();
            }
        });
        btn_tuesday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FridayAdmin.this, TuesdayAdmin.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                finish();
            }
        });
        btn_wednesday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FridayAdmin.this, WednesdayAdmin.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                finish();
            }
        });
        ...
        btn_sunday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FridayAdmin.this, SundayAdmin.class));
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            }
        });
...
//                Log.e(TAG, "onDataChange: "+ AllMethods.name );
        ...
        databaseReference = database.getReference("Schedule").child(firebaseUser.getPhoneNumber()).child("Friday");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (int i=0; i<snapshot.getChildrenCount(); i++ ) {
                        ...
                        public boolean onLongClick(View view) {
                            for (int i = 0; i < scheduleList.size(); i++) {
                                if (view.getId() == i) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(FridayAdmin.this);
                                    ...
                                    builder.setItems(options, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int j) {
                                            if (j == 0) {
                                                databaseReference = FirebaseDatabase.getInstance().getReference("Schedule").child(firebaseUser.getPhoneNumber()).child("Friday");
                                                databaseReference.child(scheduleList.get(finalI).getId()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(FridayAdmin.this, isDeleted, Toast.LENGTH_SHORT).show();
                                                        } else {
                                                            Toast.makeText(FridayAdmin.this, notDeleted, Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                });
                                                return;
                    ...
                    if (currentTime.compareTo(endTimeString) < 0 && currentTime.compareTo(startTimeString) > 0 && dayOfWeek == Calendar.FRIDAY) {
...
//            buton chat
        if (id == R.id.chatButton) {
            Intent intent = new Intent(FridayAdmin.this, AdminChatActivity.class);
...
//            buton setari
        if (id == R.id.btn_settings){
            Intent intent = new Intent (FridayAdmin.this, SettingsActivity.class);
            startActivity(intent);
            return false;
        }
//            buton logout
        if (id == R.id.btn_logout) {
            ...
            startActivity(new Intent (FridayAdmin.this, AdminPhoneRegister.class));
            finish();
        }
